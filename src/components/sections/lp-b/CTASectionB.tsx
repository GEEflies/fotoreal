    ...
    <section className="section-padding relative overflow-hidden">
      ...
      <div className="section-container relative z-10 text-center max-w-2xl mx-auto">
        <h2 className="font-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4">
          Predávajte <span className="text-primary">rýchlejšie</span> a za <span className="text-primary">vyššiu cenu</span>
        </h2>
        ...
        <p className="text-xs text-muted-foreground mt-4">
          Stačí vám mobil • Bez kreditnej karty • Výsledok za 30 sekúnd
        </p>
      </div>
    </section>
  );
